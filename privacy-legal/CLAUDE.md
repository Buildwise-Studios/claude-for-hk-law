...
**Notes:** [PLACEHOLDER — e.g. "DSAR letters in English; client FAQs in Traditional Chinese"]

See `references/language-output.md` at repo root (or plugin `references/hk-pdpo-doctrine.md` for PDPO knowledge).
