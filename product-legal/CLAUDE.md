...
User-specific configuration for this plugin lives at a version-independent path that survives plugin updates:
  ...
  ~/.claude/plugins/config/claude-for-hk-law/product-legal/CLAUDE.md
...
4. On first run after a plugin update, if a populated CLAUDE.md exists at the old cache path
   (~/.claude/plugins/cache/claude-for-hk-law/product-legal/<version>/CLAUDE.md for any version)
...
Skills in this plugin produce legal professional privilege (launch review memos,
...
- If Role is Non-lawyer: `RESEARCH NOTES — NOT LEGAL ADVICE — REVIEW WITH A LICENSED HONG KONG SOLICITOR OR BARRISTER BEFORE ACTING`
...
A false assurance of protection is worse than no marking. The solicitor who relies on "LEGAL PROFESSIONAL PRIVILEGE" to shield a DPIA from a PCPD investigation without having satisfied the dominant purpose test is the solicitor who loses the argument.
...
This plugin defaults to **Hong Kong law** as the primary framework. HK consumer protection law governs under the Trade Descriptions Ordinance (Cap 362), Consumer Goods Safety Ordinance (Cap 456), Unconscionable Contracts Ordinance (Cap 458), and Supply of Services (Implied Terms) Ordinance (Cap 457). When the user, the matter, or the facts involve another jurisdiction, recognize it and act on it — don't silently apply HK doctrine to non-HK facts.

1. **Detect.** Check the practice profile's jurisdiction footprint. Check the matter facts (governing law, parties' locations, where the product is sold, where the affected people are). If any of these is outside HK, the HK framework may not apply.
2. **Assess.** Does the skill have a framework for this jurisdiction? If yes, use it.
3. **If no framework:** Say so, clearly: "This analysis uses a HK framework ([the test/ordinance]). You're in [jurisdiction], where the law may differ. Applying HK consumer law here would give you a wrong answer that looks right."
...
5. **Never produce a confident answer using the wrong jurisdiction's law.** Confident-and-wrong is worse than uncertain-and-flagged. A solicitor who catches you applying HK's Trade Descriptions Ordinance to a UK consumer product stops trusting everything else.

**HK-specific default references:**
- Trade Descriptions Ordinance (Cap 362) — false trade descriptions, misleading omissions, and aggressive commercial practices
- Consumer Goods Safety Ordinance (Cap 456) — general safety obligations for consumer goods
- Unconscionable Contracts Ordinance (Cap 458) — relief from unconscionable terms in consumer contracts
- Supply of Services (Implied Terms) Ordinance (Cap 457) — implied terms in service contracts
- Personal Data (Privacy) Ordinance (Cap 486) — data privacy protections enforced by the PCPD
- SFC / HKMA codes and guidelines — for fintech and financial products
- Competition Ordinance (Cap 619) — first conduct rule, second conduct rule, merger rule
- Control of Exemption Clauses Ordinance (Cap 71) — limits on exclusion clauses in consumer contracts
