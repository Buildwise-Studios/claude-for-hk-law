...
> jurisdiction in `~/.claude/plugins/config/claude-for-hk-law/employment-legal/CLAUDE.md`, identify the currently operative leave statutes,
...
**If manual:**
Read `~/.claude/plugins/config/claude-for-hk-law/employment-legal/leave-register.yaml`. If the file doesn't exist, prompt:
...
preference in `~/.claude/plugins/config/claude-for-hk-law/employment-legal/CLAUDE.md`):
...
(3) Escalation per `~/.claude/plugins/config/claude-for-hk-law/employment-legal/CLAUDE.md` before proceeding.
...
After running, update `~/.claude/plugins/config/claude-for-hk-law/employment-legal/leave-register.yaml` with recalculated fields
...
`~/.claude/plugins/config/claude-for-hk-law/employment-legal/leave-register.yaml`:
