...
1. Read `~/.claude/plugins/config/claude-for-hk-law/ai-governance-legal/CLAUDE.md`. Confirm registry is populated — if not, stop and direct to setup.
...
## Read `~/.claude/plugins/config/claude-for-hk-law/ai-governance-legal/CLAUDE.md` first

Before triaging, always read `~/.claude/plugins/config/claude-for-hk-law/ai-governance-legal/CLAUDE.md`. The use case registry and red lines there
...
Check the use case registry in `~/.claude/plugins/config/claude-for-hk-law/ai-governance-legal/CLAUDE.md` for a direct or close match.
...
Before going further, check the red lines in `~/.claude/plugins/config/claude-for-hk-law/ai-governance-legal/CLAUDE.md`.
...
**Governance tier:** [Standard / Elevated / High — per `~/.claude/plugins/config/claude-for-hk-law/ai-governance-legal/CLAUDE.md`]
...
> "Add to `~/.claude/plugins/config/claude-for-hk-law/ai-governance-legal/CLAUDE.md` → Use case registry. This means next time the same request
