...
2. Identify the applicable playbook section(s) from `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`.
...
```
[#] [Deal] — [Clause]
Playbook position: [standard position from `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`]
...
Append a structured entry to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/deviation-log.yaml` for each agreement processed.
...
Logged to: ~/.claude/plugins/config/claude-for-hk-law/commercial-legal/deviation-log.yaml
