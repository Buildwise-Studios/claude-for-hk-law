...
description: >
  ...
  within a rolling 12-month window (configurable in `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`).
...
Both values are configurable in `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md` under `## Playbook monitor settings`:
...
If these fields are absent from `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`, use the defaults above.

## What it does

### Step 1 — Read the practice profile and log

1. Read `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md` in full. Extract:
...
2. Read `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/deviation-log.yaml`. Filter out:
...
If no clause crosses the threshold: log the check to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-monitor-log.yaml` and stop. Do not notify the attorney.
...
2. **Current playbook language** (exact text from `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`)
...
Current language in `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`:
...
Write all proposals to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-proposals.md`. Overwrite any existing file — stale unreviewed proposals are replaced, not accumulated.
...
Notify the attorney via the destination in `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`:
...
> Proposals: ~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-proposals.md

Log the run to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-monitor-log.yaml`:
...
- run_at: [ISO datetime]
  ...
  proposals_file: ~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-proposals.md
```
...
1. Read `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-proposals.md`. If file doesn't exist or is empty: *"No pending proposals. Playbook is up to date."* Stop.
...
[A] Accept — apply proposed language to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`
...
```
Updating `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`:
...
5. **Reject / Defer:** log to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-monitor-log.yaml` with reason if given. Do not modify `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`. A rejected proposal is not re-raised until a new pattern emerges after the rejection date.

6. After all proposals resolved, show summary:

```
Review complete.
[N] accepted and applied to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md`
[N] rejected
[N] deferred to next cycle
[N] edited and applied

`~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md` last updated: [timestamp]
Next playbook check: after [N] more deals are logged
```

7. Archive: rename `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-proposals.md` to `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/playbook-proposals-[YYYYMMDD].md`. The active file is now clear.

## What this agent does NOT do

- Modify `~/.claude/plugins/config/claude-for-hk-law/commercial-legal/CLAUDE.md` without explicit per-change attorney confirmation
