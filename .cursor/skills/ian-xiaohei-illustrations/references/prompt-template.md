...
Use when the article or user is English. In Cursor, prepend the STYLE LOCK block from `cursor-generate-image.md`.

```text
Generate one standalone 16:9 horizontal article illustration.

STYLE LOCK — follow exactly:
Pure flat WHITE background only. Black HAND-DRAWN wobbly pen sketch. NOT infographic. NOT UI mockup. NOT dark theme. NOT 3D. NOT corporate poster. NOT numbered steps layout.

Xiaohei: small solid-black blob, white dot eyes, thin stick legs, blank deadpan face. Xiaohei performs the core action.
...
English handwritten labels (max 5–8, sparse):
{label1} / {label2} / {label3} / {label4}

Orange = flow. Red = emphasis. Blue = secondary notes. 35%+ white margin.
```
