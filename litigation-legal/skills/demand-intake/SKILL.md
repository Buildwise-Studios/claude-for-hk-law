...
1. Load `~/.claude/plugins/config/claude-for-hk-law/litigation-legal/CLAUDE.md` → demand-letter practice, landscape, risk calibration.
...
5. Write `~/.claude/plugins/config/claude-for-hk-law/litigation-legal/demand-letters/[slug]/intake.md`.
...
- Desired outcome dollar value ≥ the medium-severity band from `~/.claude/plugins/config/claude-for-hk-law/litigation-legal/CLAUDE.md` risk calibration
- Counterparty is a customer, competitor, or frequent adversary per `~/.claude/plugins/config/claude-for-hk-law/litigation-legal/CLAUDE.md` landscape
- User ran with `--full`
...
`[type]-[counterparty-short]-[yyyy-mm]`. Confirm uniqueness in `~/.claude/plugins/config/claude-for-hk-law/litigation-legal/demand-letters/`.

### `~/.claude/plugins/config/claude-for-hk-law/litigation-legal/demand-letters/[slug]/intake.md`
...
- Run the conflicts check. If the counterparty is a customer or known entity, flag that this should clear conflicts (per `~/.claude/plugins/config/claude-for-hk-law/litigation-legal/CLAUDE.md`) before sending — but the check itself lives in the matter-intake workflow or outside this skill.
